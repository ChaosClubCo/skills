...
version: "1.0.0"
description: >
  Performs comprehensive codebase analysis covering architecture, code quality, security,
  performance, testing, and maintainability. Use when reviewing code for production readiness,
  identifying technical debt, finding security vulnerabilities, assessing test coverage, or
  getting a full codebase health check. Triggers on: audit this code, review the codebase,
  code review, find issues, check for bugs, security audit, performance review, code quality
  check, technical debt, is this production ready, review my code, analyze this repo, code
  smell, what's wrong with this code, find vulnerabilities, assess test coverage, code health,
  refactor review, pre-deploy review, or any request to evaluate existing code quality before
  shipping, merging, or presenting to stakeholders.
---
