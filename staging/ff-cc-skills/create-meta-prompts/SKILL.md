...
### Result Presentation Examples
Full annotated single-result and chain-result presentation examples:
→ See `references/special-cases.md`



## Special Cases & Reference Guides

Edge cases (re-running, output conflicts, recursive prompts, commit handling):
→ See `references/special-cases.md`

Pattern libraries by prompt purpose (Do, Plan, Research, Refine):
→ See `references/do-patterns.md`, `references/plan-patterns.md`, `references/research-patterns.md`, `references/refine-patterns.md`

Shared templates: `references/summary-template.md`, `references/metadata-guidelines.md`
