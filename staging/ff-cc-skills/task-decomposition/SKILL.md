...
This is the one place where asking a clarifying question mid-response is worth the interruption. A wrong cross-cutting decision costs more than the delay.
...
4. If a workstream's deliverable is best produced by another installed skill (e.g., a docx by intinc-doc-generator, a presentation by the pptx skill), name the skill and describe what it should produce — then either chain to it or flag it for the user
