...
description: Write press releases for media distribution. Use when write press releases for media distribution. Triggers on: press, release, writing, content, creative work.
version: 1.0.0
...
## Purpose
Write press releases for media distribution.
