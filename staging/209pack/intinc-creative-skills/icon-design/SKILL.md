---
name: icon-design
description: Design icon sets with consistent style. Use when design icon sets with consistent style. Triggers on: icon, design, design, creative work.
version: 1.0.0
...
## Purpose
Design icon sets with consistent style.
