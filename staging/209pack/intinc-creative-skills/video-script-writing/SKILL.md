...
description: Write scripts for product demos and explainer videos. Use when write scripts for product demos and explainer videos. Triggers on: video, script, writing, content, creative work.
version: 1.0.0
...
## Purpose
Write scripts for product demos and explainer videos.
