...
description: Implement API rate limiting with token buckets and sliding windows. Use when implement api rate limiting with token buckets and sliding windows. Triggers on: rate, limiting, implementation, data engineering, technical implementation.
version: 1.0.0
...
## Purpose
Implement API rate limiting with token buckets and sliding windows.

## When to Use
- Building production systems requiring rate limiting implementation
