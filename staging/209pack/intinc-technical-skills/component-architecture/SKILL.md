...
description: Design reusable component libraries with composition patterns. Use when design reusable component libraries with composition patterns. Triggers on: component, architecture, frontend, technical implementation.
version: 1.0.0
...
## Purpose
Design reusable component libraries with composition patterns.

## When to Use
- Building production systems requiring component architecture
- Technical architecture decisions for frontend
