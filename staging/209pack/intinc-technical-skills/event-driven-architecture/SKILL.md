...
description: Build event-driven systems with message brokers and event sourcing. Use when build event-driven systems with message brokers and event sourcing. Triggers on: event, driven, architecture, data engineering, technical implementation.
version: 1.0.0
...
## Purpose
Build event-driven systems with message brokers and event sourcing.

## When to Use
- Building production systems requiring event driven architecture
