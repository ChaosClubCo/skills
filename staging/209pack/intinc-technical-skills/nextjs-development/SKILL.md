...
description: Create Next.js applications with SSR, SSG, and API routes. Use when create next.js applications with ssr, ssg, and api routes. Triggers on: nextjs, development, frontend, technical implementation.
version: 1.0.0
...
## Purpose
Create Next.js applications with SSR, SSG, and API routes.

## When to Use
- Building production systems requiring nextjs development
