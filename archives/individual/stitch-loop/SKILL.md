---
name: stitch-loop
description: "Autonomous iterative website building using Stitch with baton-passing loop pattern. Use when building websites iteratively with Stitch, implementing autonomous page generation workflows, coordinating multi-step construction processes, managing site integration loops, or executing continuous development cycles. Requires DESIGN.md and SITE.md for consistency. Keywords: stitch, build loop, iterative, autonomous, baton passing, website generation, continuous development, site integration, multi-step workflow, next-prompt, queue management."
metadata:
  version: "1.0.0"
---
