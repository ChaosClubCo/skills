...
description: Four-phase debugging framework that ensures root cause investigation before attempting fixes. Never jump to solutions. Use when configuring, building, or troubleshooting AI agent workflows.
---
