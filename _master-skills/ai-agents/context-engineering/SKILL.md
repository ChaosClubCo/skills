...
description: Helps configure and build context engineering processes. Context engineering curates the smallest high-signal token set for LLM tasks. The goal: maximize reasoning quality while minimizing token usage. Use when configuring, building, or troubleshooting AI agent workflows.
---
