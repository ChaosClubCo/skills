...
description: Helps configure and build inversion exercise processes. Flip core assumptions to reveal hidden constraints and alternative approaches - "what if the opposite were true?. Use when configuring, building, or troubleshooting AI agent workflows.
---
