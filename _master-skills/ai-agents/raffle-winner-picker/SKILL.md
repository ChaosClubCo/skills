...
description: Picks random winners from lists, spreadsheets, or Google Sheets for giveaways, raffles, and contests. Ensures fair, unbiased selection with transparency. Use when configuring, building, or troubleshooting AI agent workflows.
---
