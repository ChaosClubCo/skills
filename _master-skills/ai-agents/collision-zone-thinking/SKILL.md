...
description: Helps configure and build collision zone thinking processes. Force unrelated concepts together to discover emergent properties - "What if we treated X like Y?. Use when configuring, building, or troubleshooting AI agent workflows.
---
