...
description: Design a PostgreSQL-specific schema. Covers best-practices, data types, indexing, constraints, performance patterns, and advanced features. Use when building, debugging, or optimizing technical implementations.
---
